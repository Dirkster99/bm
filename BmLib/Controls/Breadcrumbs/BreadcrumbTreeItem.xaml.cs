...
/***
    [TemplateVisualState(Name = "ShowCaption", GroupName = "CaptionStates")]
    [TemplateVisualState(Name = "HideCaption", GroupName = "CaptionStates")]
    public class CopyOfBreadcrumbTreeItem : TreeViewItem
    {
        #region fields
        public static readonly DependencyProperty OverflowItemCountProperty = OverflowableStackPanel.OverflowItemCountProperty
        .AddOwner(typeof(CopyOfBreadcrumbTreeItem), new PropertyMetadata(OnOverflowItemCountChanged));

        public static readonly DependencyProperty IsOverflowedProperty = DependencyProperty.Register("IsOverflowed", typeof(bool),
         typeof(CopyOfBreadcrumbTreeItem), new PropertyMetadata(false));

        ////		public static readonly DependencyProperty OverflowedItemContainerStyleProperty =
        ////						BreadcrumbTree.OverflowedItemContainerStyleProperty.AddOwner(typeof(CopyOfBreadcrumbTreeItem));

        public static readonly DependencyProperty SelectedChildProperty =
            DependencyProperty.Register("SelectedChild", typeof(object), typeof(CopyOfBreadcrumbTreeItem),
                    new UIPropertyMetadata(null));

        public static readonly DependencyProperty ValuePathProperty =
         DependencyProperty.Register("ValuePath", typeof(string), typeof(CopyOfBreadcrumbTreeItem),
                 new UIPropertyMetadata(string.Empty));

        public static readonly DependencyProperty IsChildSelectedProperty =
                DependencyProperty.Register("IsChildSelected", typeof(bool), typeof(CopyOfBreadcrumbTreeItem),
                        new UIPropertyMetadata());

        public static readonly DependencyProperty IsCurrentSelectedProperty =
             DependencyProperty.Register("IsCurrentSelected", typeof(bool), typeof(CopyOfBreadcrumbTreeItem),
                     new UIPropertyMetadata(false));

        public static readonly DependencyProperty IsCaptionVisibleProperty =
                                DependencyProperty.Register("IsCaptionVisible", typeof(bool), typeof(CopyOfBreadcrumbTreeItem),
                                new UIPropertyMetadata(true, OnIsCaptionVisibleChanged));

        public static readonly DependencyProperty MenuItemTemplateProperty =
                        BreadcrumbTree.MenuItemTemplateProperty.AddOwner(typeof(CopyOfBreadcrumbTreeItem));
        #endregion fields
        ...
        /// Static constructor
        /// </summary>
        static CopyOfBreadcrumbTreeItem()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(CopyOfBreadcrumbTreeItem),
                    new FrameworkPropertyMetadata(typeof(CopyOfBreadcrumbTreeItem)));
        }

        /// <summary>
        /// Class constructor
        /// </summary>
        public CopyOfBreadcrumbTreeItem()
        {
        }
        #endregion
        ...
        public static void OnIsCaptionVisibleChanged(object sender, DependencyPropertyChangedEventArgs args)
        {
            (sender as CopyOfBreadcrumbTreeItem).UpdateStates(true);
        }

        public static void OnOverflowItemCountChanged(object sender, DependencyPropertyChangedEventArgs args)
        {
            (sender as CopyOfBreadcrumbTreeItem).SetValue(IsOverflowedProperty, ((int)args.NewValue) > 0);
        }
        ...
        protected override DependencyObject GetContainerForItemOverride()
        {
            return new CopyOfBreadcrumbTreeItem();
        }
