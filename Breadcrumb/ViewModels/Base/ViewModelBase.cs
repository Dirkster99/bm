namespace Breadcrumb.ViewModels.Base
{
    using System;
    ...
    internal class ViewModelBase : INotifyPropertyChanged
    {
        ...
        public void NotifyOfPropertyChanged<TProperty>(Expression<Func<TProperty>> property)
        {
            ...
            this.NotifyOfPropertyChanged(memberExpression.Member.Name);
        }
